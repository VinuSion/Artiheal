...
interface Task extends Document {
  foodReference: Schema.Types.ObjectId; // Referencia al ID del alimento relacionado
...
const TaskSchema = new Schema({
  foodReference: { type: Schema.Types.ObjectId, ref: "Food", required: true }, // Referencia a -> "foodModel.ts"
